(function($) {
  ...
  $("#btn-search-actors").click(function(){
		...
		$.ajax( {
			...
			type: "GET",
			url: '/Seccion10_Grupo07/HelloServlet',
	...
	$("#btn-search-movies-by-actor").click(function(){
		...
		$.ajax( {
			...
			type: "GET",
			url: '/Seccion10_Grupo07/MoviesByActor?actor_name=' + $('#txt-actor').val(),
			success: function(data) {
				//alert("Result" + data.resultado);
	...
	$("#btn-movie-insert").click(function(){
		...
		//alert("Resultado: " + '/Seccion10_Grupo07/SaveMovieServlet?title=' + $('#txt-movie-title').val() + '&release_year=' + $('#txt-movie-release_year').val() + '&tagline=' + $('#txt-movie-tagline').val());
				
		$.ajax( {
			
			type: "GET",
			url: '/Seccion10_Grupo07/SaveMovieServlet?title=' + $('#txt-movie-title').val() + '&release_year=' + $('#txt-movie-release_year').val() + '&tagline=' + $('#txt-movie-tagline').val() ,
			success: function(data) {
